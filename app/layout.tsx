    ...
    <html lang="en">
      <body className={`${inter.className} bg-[#e2e4e7] text-slate-900 min-h-screen pb-24 md:pb-8 font-sans`}>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex items-center justify-between h-20">
              ...
              <div className="flex items-center space-x-2 bg-white/20 border border-white/40 p-1 rounded-full">
                <Link href="/" className="bg-[#1a1a1a] text-white px-6 py-2 rounded-full text-sm font-semibold transition-colors">Explore</Link>
                <Link href="/bookings" className="text-slate-600 hover:text-slate-900 px-6 py-2 rounded-full text-sm font-semibold transition-colors">My Tickets</Link>
              </div>
              <div className="w-10 h-10 bg-slate-300 rounded-full overflow-hidden shadow-sm">
        ...
        <nav className="md:hidden flex items-center justify-between p-6 pb-2">
          {/* Hamburger Menu */}
          <div className="w-12 h-12 rounded-full border border-white/60 flex items-center justify-center shadow-sm text-slate-700 bg-white/20 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="w-12 h-12 bg-slate-300 rounded-full overflow-hidden shadow-sm">
              <img src="https://api.dicebear.com/7.x/avataaars/svg?seed=Felix" alt="Avatar" className="w-full h-full object-cover" />
            </div>
          </div>
        </nav>
